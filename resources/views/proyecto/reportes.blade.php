    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card card-default">
                ...
                <div class="card-body">
<form method="POST" action="{{ route('proyectos.reporte_pdf') }}"  role="form" enctype="multipart/form-data" class="submit-prevent-form" target="_black">
    @csrf
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">    
                        ...
                        <div class="col-md-4">    
                            <div class="form-group">
                                {{ Form::label('Tipo') }}
                                {{ Form::select('tipo', ['INGRESO'  => 'INGRESO', 'EGRESO'  => 'EGRESO'], 0, ['class' => 'form-control' . ($errors->has('tipo') ? ' is-invalid' : ''), 'placeholder' => 'Seleccione uno']) }}
                            ...
                            <div class="form-group">
                                ...
                                {{ Form::select('corporacion_id', $corporaciones, 0, ['class' => 'form-control' . ($errors->has('corporacion_id') ? ' is-invalid' : ''), 'placeholder' => 'Seleccione uno']) }}
