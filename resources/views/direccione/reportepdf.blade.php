...
<head>
    ...
    <title> REPORTE DE DIRECCIONES</title>
         ...
         <!-- Inicio de tabla con todas las AYUDAS SOCIALES -->
            ...
            <table class="table table-bordered table-sm resumen">
                                  ...
                                  <table class="table table-bordered table-sm resumen">
                                    <thead class="thead">
                                        <tr>
                                            <th style="text-align: center">RESUMEN DIRECCIONES</th>
                                    ...
                                    <tbody>
                                           <tr>
                                             ...
                                             <td style="text-align: center">{{ $datos['total_direcciones'] }}</td>
                                 ...
                                 <table class="table table-bordered table-sm resumen">
                                    ...
                                    <tbody>
                                           <tr>
                                             ...
                                             <td style="text-align: center">{{ $datos['nombre_municipio'] }}</td>
                                             <td style="text-align: center"> {{ $datos['nombre_parroquia'] }}</td>
