...
<head>
    ...
    <title> REPORTE DE CORPORACIONES</title>
                ...
                <div class="row text-center justify-content">
                    ...
                    <div class="col-md-12">
                            <div class="text-center justify-content">
                                    ...
                                    G-20016716-5<br>
                                    <h4>
                                    Listado de Corporaciones<br></h4>
                                </h2>
            ...
            <table class="table table-bordered table-sm resumen">
                                      ...
                                      @foreach ($corporaciones as $corporacione)
                                        <tr>
                                            ...
                                            <td><img src="{{ asset ($corporacione->imagen) }}" class="img-responsive" style="max-height: 80px; max-width: 80px" alt=""></td>
                                  ...
                                  <table class="table table-bordered table-sm resumen">
                                    <thead class="thead">
                                        <tr>
                                            <th style="text-align: center">RESUMEN CORPORACIONES</th>
